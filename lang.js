...
const translations = {
  ...
  en: {
    ...
    formMessage: "Message",
    formSubmit: "Get Free Sourcing Solution",
    formPrivacy: "We respect your privacy. Response within 24 hours.",
    contactInfoTitle: "Contact Information",
    contactInfoEmail: "Corporate Email:",
    contactInfoPhone: "Phone/WhatsApp:",
    contactInfoSocial: "Social Network:",
    badgeResponse: "24hr Response",
    badgeVerified: "Verified Supplier",
    statManufacturers: "Top HPHT Manufacturers",
  ...
  hi: {
    ...
    formMessage: "संदेश",
    formSubmit: "मुफ्त सोर्सिंग समाधान प्राप्त करें",
    formPrivacy: "हम आपकी गोपनीयता का सम्मान करते हैं। 24 घंटों के भीतर प्रतिक्रिया।",
    contactInfoTitle: "संपर्क जानकारी",
    contactInfoEmail: "कॉर्पोरेट ईमेल:",
    contactInfoPhone: "फोन/WhatsApp:",
    contactInfoSocial: "सामाजिक नेटवर्क:",
    badgeResponse: "24 घंटे प्रतिक्रिया",
    badgeVerified: "सत्यापित आपूर्तिकर्ता",
    statManufacturers: "शीर्ष एचपीएचटी निर्माता",
    statClients: "वैश्विक ग्राहक",
    statSavings: "लागत बचत",
  ...
  ja: {
    ...
    formMessage: "メッセージ",
    formSubmit: "無料調達ソリューションを取得",
    formPrivacy: "プライバシーを尊重します。24時間以内に返信。",
    contactInfoTitle: "連絡先情報",
    contactInfoEmail: "会社のEメール:",
    contactInfoPhone: "電話/WhatsApp:",
    contactInfoSocial: "ソーシャルネットワーク:",
    badgeResponse: "24時間対応",
    badgeVerified: "認定サプライヤー",
    statManufacturers: "トップHPHTメーカー",
    statClients: "グローバル顧客",
    statSavings: "コスト削減",
