...
const translations = {
  ...
  zh: {
    ...
    solutionA1: "<strong>稳定的供应保障:</strong> 我们与中国顶尖的HPHT生产商建立了长期战略合作关系，确保您能获得持续、可预测的毛坯供应。",
    solutionA2: "<strong>严格的可追溯性:</strong> 我们提供的每一批毛坯都具备清晰的来源记录，为您和您的客户提供了坚实的信心保证。",
    solutionA3: "<strong>卓越的晶体品质:</strong> 我们精通HPHT技术，只为您筛选出晶体形态优良、瑕疵少的毛坯，从源头提升您的成品率和利润空间。",
    solutionA4: "<strong>战略风险对冲:</strong> 将 Kunlun Growth 作为您的战略采购伙伴，意味着您拥有了一个可靠的“供应链B计划”，有效对冲地缘政治和市场波动带来的风险。",
    solutionBTitle: "成品直销 (服务珠宝品牌和批发商)",
    solutionBTarget: "专门针对北美客户",
    solutionBSubtitle: "在地品控，管家服务：轻松采购，价格更优。",
    solutionB1: "<strong>在地品控:</strong> 我们的团队在中国源头为您执行严格的品质检验，确保每一颗钻石都100%符合您的订单要求。",
    solutionB2: "<strong>管家式服务:</strong> 我们提供从采购、检验、物流到清关的全流程“管家式”服务，让您能专注于市场和销售。",
    solutionB3: "<strong>极具竞争力的价格:</strong> 通过整合供应链，我们剔除了不必要的中间商环节，将中国制造的成本优势直接传递给您。",
  ...
  ja: {
    ...
    solutionA1: "<strong>安定した供給保証:</strong> 私たちは中国のトップHPHT生産者と長期的な戦略的パートナーシップを確立し、原石ダイヤモンドの継続的で予測可能な供給を保証します。",
    solutionA2: "<strong>厳格な追跡可能性:</strong> 私たちが提供するすべての原石ダイヤモンドのバッチには、明確な原産地の記録が付属しており、あなたとあなたのクライアントに確固たる信頼を提供します。",
    solutionA3: "<strong>優れた結晶品質:</strong> 私たちはHPHT技術に特化し、優れた結晶形態と少ない内包物を持つ原石ダイヤモンドのみを選択し、供給元からあなたの歩留まりと利益率を高めます。",
    solutionA4: "<strong>戦略的リスクヘッジ:</strong> クンルン・グロースとの提携は、信頼性の高い「サプライチェーンプランB」を持つことを意味し、地政学的および市場の変動リスクを効果的にヘッジします。",
    ...
    solutionB1: "<strong>現地での品質管理:</strong> 中国の私たちのチームは、すべてのダイヤモンドがあなたの注文要件を100%満たすように、厳格な品質検査を実施します。",
    solutionB2: "<strong>コンシェルジュサービス:</strong> 私たちは、調達、検査、物流から通関までの全プロセスを「コンシェルジュ」サービスとして提供し、あなたが市場と販売に集中できるようにします。",
    solutionB3: "<strong>非常に競争力のある価格設定:</strong> サプライチェーンを統合することにより、不要な中間業者を排除し、中国製造のコスト優位性を直接あなたに提供します。",
    solutionB4: "<strong>シームレスなコミュニケーション:</strong> 北米に拠点を置く私たちのチームは、時差や障壁なくあなたとコミュニケーションをとり、あなたのビジネスニーズを深く理解します。",
    contactTitle: "お問い合わせ",
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const setLanguage = (lang) => {
    ...
    // Update active language in the switcher
  ...
  if (savedLang && supportedLangs.includes(savedLang)) {
    ...
    // 2. Else, use browser language if supported
